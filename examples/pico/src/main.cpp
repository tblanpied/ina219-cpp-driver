...
class Ina219PicoProvider : public ina219::Provider {
  public:
    ...
    bool i2cWrite(
        uint8_t addr, const uint8_t* data, std::size_t len, bool nostop = false ) override {
...
static void print_readings(
    uint32_t busVoltage_mV, int32_t shuntVoltage_uV, float current_mA, float power_mW ) {
